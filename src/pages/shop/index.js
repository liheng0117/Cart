...
class index extends Component {
    ...
    render() {
        const { img, title, price, freight, sales, commet, visable, size, color,num } = this.state
        ...
        return (
            <section>
                    ...
                    <div className="swiper-wrapper">
                        {
                            img ? img.map((v, i) => {
                                return (
                                    <div key={i} className="swiper-slide"><img src={v} /></div>
                                )
                            }) : null
                        }
                    </div>
                ...
                <div className='Btn'><button className='collect'>收藏</button><button className='join' onClick={this.handlmask}>加入购物车</button></div>
                    ...
                    <div className='mask-box'>
                        ...
                        <div className='shop-coloe'>
                            ...
                            <div>
                            {
                                color.map((v, i) => {
                                    return (
                                        <span className='shop-color-arr' key={i} onClick={()=>this.colorclick(i)}>{v.value}</span>
                                    )
                                })
                            }
                            </div>
                            ...
                            <div>
                                {
                                    size.map((v, i) => {
                                        return (
                                            <span  className='shop-color-brr' key={i} onClick={()=>this.sizeclick(i)}>{v.value}</span>
                                        )
                                    })
                                }
                            </div>
                        ...
                        <p>购买数量</p>
                        <p className='shop-emendation'><span onClick={this.subtract}>-</span><span>{ num }</span><span onClick={this.add}>+</span></p>
                        </div>
